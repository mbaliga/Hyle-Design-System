...
<div id="panel">
  ...
  <div class="group"><span class="lbl">Scene</span><div class="chips" id="scene">
    <button class="chip" data-scn="0" aria-pressed="true">Bowl</button>
    <button class="chip" data-scn="1" aria-pressed="false">Helix</button>
...
var state={
  scene:0,speed:.28,grain:.5,glow:1.2,aim:2.2,void:.5,pattern:0,texType:0,inner:.3,grit:1.0,coarse:.5,grainSc:.5,zoom:.5,count:5,yaw:0,tilt:0,
